...
test("unknown schema and malformed data are rejected",()=>{for(const value of [{schemaVersion:1},{...emptyWorkspace(),maxLength:99},{...emptyWorkspace(),target:[]},{...emptyWorkspace(),extra:"unsupported"}])assert.throws(()=>parseWorkspace(JSON.stringify(value)));});
